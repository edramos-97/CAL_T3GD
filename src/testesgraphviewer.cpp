/*
 * testesgraphviewer.cpp
 *
 *  Created on: 02/04/2017
 *      Author: Xavier Fontes
 */

#include "testesgraphviewer.h"

testes_graphviewer::testes_graphviewer() {
}

void testes_graphviewer::exercicio1() {
...
void testes_graphviewer::exercicio2() {
...
void testes_graphviewer::exercicio3() {
	GraphViewer *gv = new GraphViewer(600, 600, false);
...
void testes_graphviewer::exercicioTeste() {
